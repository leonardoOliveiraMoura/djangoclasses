...
class PaginationTest(TestCase):
    def test_make_pagination_range_returns_a_pagination_range(self):
        print('make_pagination_range_returns_a_pagination_range')
    ...
    def test_first_range_is_static_if_current_page_is_less_than_middle_page(self):  # noqa: E501
        print('first_range_is_static_if_current_page_is_less_than_middle_page')
    ...
    def test_make_sure_middle_ranges_are_correct(self):
        print('make_sure_middle_ranges_are_correct')
    ...
    def test_make_pagination_range_is_static_when_last_page_is_next(self):
        print('make_pagination_range_is_static_when_last_page_is_next')
